// app/routes/apps.leadform.communes.tsx
...
function verifyAppProxyRequest(url: URL): VerifyResult {
  ...
  // App Proxy commonly uses `signature`; some setups may include `hmac`.
  ...
  // Build the signed message exactly per Shopify App Proxy rules:
  // - parse query string (preserves repeated keys as arrays)
  // - remove signature/hmac
  // - for each key: "k=v1,v2" (values joined by comma)
  // - sort keys
